...
if("FALSE" STREQUAL "TRUE")
  set(clear_costmap_recovery_SOURCE_PREFIX /home/book/catkin_ws/src/navigation/clear_costmap_recovery)
  set(clear_costmap_recovery_DEVEL_PREFIX /home/book/catkin_ws/devel)
  ...
  set(clear_costmap_recovery_INSTALL_PREFIX /home/book/catkin_ws/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'clear_costmap_recovery' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/book/catkin_ws/install/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/book/catkin_ws/install/lib;/home/book/cartographer_ws/install_isolated/lib;/home/book/stdr_ws/devel/lib;/home/book/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
