...
if("FALSE" STREQUAL "TRUE")
  set(navfn_SOURCE_PREFIX /home/book/catkin_ws/src/navigation/navfn)
  set(navfn_DEVEL_PREFIX /home/book/catkin_ws/devel)
  set(navfn_INSTALL_PREFIX "")
  set(navfn_PREFIX ${navfn_DEVEL_PREFIX})
else()
  set(navfn_SOURCE_PREFIX "")
  set(navfn_DEVEL_PREFIX "")
  set(navfn_INSTALL_PREFIX /home/book/catkin_ws/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'navfn' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/book/catkin_ws/install/${idir}'.  ${_report}")
    endif()
